...
$GLOBALS['language'] = array (
    'website' => array (
        ...
        'base' => array(
            ...
            'nav_news'              => 'Nieuws',
            'nav_jobs'              => 'Solliciteren',
            'nav_photos'            => 'Foto\'s',
            'nav_staff'             => 'Medewerkers',
            'nav_exchange'          => 'Marktplaats',

            'nav_shop'              => 'winkel',
            'nav_buy_points'        => 'Bel-Credits kopen',
            'nav_buy_club'          =>  Config::site['shortname'] . ' VIP kopen',
            'nav_purchasehistory'   => 'Aankoopgeschiedenis',
            'nav_changename'        =>  Config::site['shortname'] . 'naam veranderen',

            'nav_highscores'        => 'Top Nabro\'s',
